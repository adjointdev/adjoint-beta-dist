"""
Privacy-focused, anonymous telemetry system for Adjoint
...
def _version_from_local_pyproject() -> str:
    ...
    for parent in current.parents:
        ...
        if version:
            return version
    raise FileNotFoundError("pyproject.toml not found for AdjointServer")
...
class TelemetryConfig:
    ...
    def __init__(self):
        ...
        default_ep = cfg_default or "https://api-prod.adjoint.pro/telemetry/events"
