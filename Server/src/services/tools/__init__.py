"""Adjoint tools package - auto-discovery and Unity routing helpers."""
...
def register_all_tools(mcp: FastMCP):
    ...
    Any .py file in this directory or subdirectories with @adjoint_tool decorated
    functions will be automatically registered.
    """
    logger.info("Auto-discovering Adjoint Server tools...")
    ...
    if not tools:
        logger.warning("No Adjoint tools registered!")
        return
    ...
    logger.info(f"Registered {len(tools)} Adjoint tools")
