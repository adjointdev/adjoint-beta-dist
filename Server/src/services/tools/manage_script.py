...
@adjoint_tool(description=("Create a new C# script at the given project path."))
...
@adjoint_tool(description=("Delete a C# script by URI or Assets-relative path."))
...
@adjoint_tool(description=("Validate a C# script and return diagnostics."))
...
@adjoint_tool(description=("Compatibility router for legacy script operations. Prefer apply_text_edits (ranges) or script_apply_edits (structured) for edits."))
...
@adjoint_tool(description="Get SHA256 and basic metadata for a Unity C# script without returning file contents")
async def get_sha(
    ctx: Context,
    uri: Annotated[str, "URI of the script to edit under Assets/ directory, unity://path/Assets/... or file://... or Assets/..."],
) -> dict[str, Any]:
