"""Defines the batch_execute tool for orchestrating multiple Unity Adjoint commands."""
...
@adjoint_tool(
    name="batch_execute",
    description=(
        "Runs a list of Adjoint tool calls as one batch. Use it to send a full sequence of commands, "
