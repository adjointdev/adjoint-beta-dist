"""
Adjoint Resources package - Auto-discovers and registers all resources in this directory.
"""
import inspect
import logging
...
def register_all_resources(mcp: FastMCP):
    ...
    Any .py file in this directory or subdirectories with @adjoint_resource decorated
    functions will be automatically registered.
    """
    logger.info("Auto-discovering Adjoint Server resources...")
    ...
    if not resources:
        logger.warning("No Adjoint resources registered!")
        return
    ...
    logger.info(
        f"Registered {registered_count} Adjoint resources ({len(resources)} unique)")
