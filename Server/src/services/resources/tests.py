...
from services.registry import adjoint_resource
...
@adjoint_resource(uri="adjoint://tests", name="get_tests", description="Provides a list of all tests.")
...
@adjoint_resource(uri="adjoint://tests/{mode}", name="get_tests_for_mode", description="Provides a list of tests for a specific mode.")
