"""
Port discovery utility for Adjoint Server.
...
- This module now scans for both patterns, prefers the most recently
  modified file, and verifies that the port is actually an Adjoint listener
...
class PortDiscovery:
    ...
    def _try_probe_unity_mcp(port: int) -> bool:
        """Quickly check if an Adjoint listener is on this port.
